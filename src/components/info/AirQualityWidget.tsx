...
export function AirQualityWidget() {
  ...
  const [lastUpdated] = useState<string>('2 hours ago');
  ...
  if (loading) {
    return (
      <article className="bg-white rounded-2xl p-8 border border-[#E8E8E8] shadow-[0_4px_20px_rgba(0,0,0,0.08)] flex flex-col h-full">
  ...
  return (
    <article className="bg-white rounded-2xl p-8 border border-[#E8E8E8] shadow-[0_4px_20px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-200 flex flex-col h-full">
      ...
      <div className="text-center mb-6 flex-1 flex flex-col justify-center">
        ...
        {/* Description - Fixed max-width */}
        <p className="text-[15px] text-[#666] leading-relaxed mx-auto mb-4" style={{ maxWidth: '280px', lineHeight: '1.7' }}>
          {airQuality.recommendation}
        </p>

        {/* Last Updated - Fixed positioning and icon */}
        <div className="flex items-center justify-center gap-1.5 text-[13px] text-[#999] mb-4">
      ...
      {/* AQI Scale Legend - Fixed colors */}
      <div className="pt-6 border-t border-[#E8E8E8] mt-auto">
        <h4 className="text-xs font-semibold text-[#666] uppercase tracking-wide mb-4" style={{ letterSpacing: '1px' }}>AQI SCALE</h4>
        
        {/* Horizontal Bar - Fixed colors */}
        <div className="mb-4">
          <div className="flex h-2 rounded-full overflow-hidden mb-3">
            <div className="w-1/4" style={{ backgroundColor: '#8BA888' }}></div>
            <div className="w-1/4" style={{ backgroundColor: '#F4C430' }}></div>
            <div className="w-1/4" style={{ backgroundColor: '#E8924F' }}></div>
            <div className="w-1/4" style={{ backgroundColor: '#D14343' }}></div>
          </div>
          <div className="flex text-[11px] text-[#2C2C2C]">
        ...
        {/* Learn More Link - Fixed styling with Unicode arrow */}
        <a
          href="/mountain-conditions"
          className="block text-center text-sm text-[#2D5F4F] hover:text-[#1F4436] hover:underline transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#2D5F4F] focus:ring-offset-2 rounded"
