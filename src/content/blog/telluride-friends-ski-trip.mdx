...
featured: false
featuredImage: "https://images.pexels.com/photos/11747546/pexels-photo-11747546.jpeg?auto=compress&w=1400&h=900&fit=crop&dpr=2"
featuredImageAlt: "Skiers gliding down the snowy slopes surrounded by a winter forest"
...
<HotelGrid 
  hotelIds={["lp656c95d8", "lpd153e", "lp35351"]}
...
<BlogMap 
  preset="overview"
  caption="Friend groups choose between downtown Telluride's nightlife scene and Mountain Village's ski-in/ski-out convenience"
  client:load
/>
...
Location considerations matter for friend groups differently than families. Mountain Village condos provide [ski-in/ski-out convenience](/lodging?filter=ski-in-ski-out) and proximity to après-ski activities, creating seamless experiences from skiing to socializing. [Downtown Telluride condos](/lodging?location=downtown) offer gondola access to skiing plus walkable access to restaurants, bars, and nightlife, creating different atmospheres that some groups prefer. The [free gondola](/blog/planning-tips/telluride-gondola-guide) connecting both areas means groups can choose either location without sacrificing access to the other.
...
![A group of skiers gather at a snow-covered mountain resort under overcast skies](https://images.pexels.com/photos/15324804/pexels-photo-15324804.jpeg?auto=compress&w=1200&h=800&fit=crop)
...
<HotelComparison 
  hotelIds={["lp4b27f", "lp656c95d8", "lpd153e"]}
  title="Compare: Hotels vs Condos by Cost Per Person"
  client:load
/>
...
Après-ski activities provide important social time that friend groups often prioritize. Telluride's après-ski scene includes bars, restaurants, and gathering spots in both Mountain Village and downtown. According to [Telluride Ski Resort](https://www.telluride.com/things-to-do/apres-ski), the resort offers numerous on-mountain bars and base area venues. Many friend groups establish après-ski meet-up locations and times, creating natural transition points from skiing to socializing. The free gondola between areas means groups can easily move between Mountain Village and downtown for different après-ski atmospheres. For more activity ideas, explore our [things to do guide](/blog/activity-guides/things-to-do-telluride).

![A snowy winter scene at a mountain bar with bundled-up visitors](https://images.pexels.com/photos/20752231/pexels-photo-20752231.jpeg?auto=compress&w=1200&h=800&fit=crop&dpr=2)
*Photo by [Phil Evenden](https://www.pexels.com/@philevenphotos) via Pexels*
...
Terrain selection becomes important when skiing as groups. [Telluride's diverse terrain](https://www.telluride.com/ski-and-snowboard/terrain) spans 2,000 acres across all ability levels, meaning groups can find runs that accommodate different abilities. Intermediate runs provide good compromise terrain for mixed groups. Groups should communicate about comfort levels and be willing to split when necessary rather than forcing people into terrain that's too challenging or too easy. For terrain strategies by ability level, see our [ski resort guide](/blog/ski-guides/telluride-ski-resort-guide).
...
<ArticleBookingWidget 
  title="Book Your Group Ski Trip"
  description="Find group accommodations in Telluride perfect for friends ski trips with real-time availability."
  variant="featured"
  client:load
/>
